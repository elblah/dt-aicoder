...
def test_shell_command_with_children_timeout():
    ...
    print("✓ Child process timeout test passed - all child processes properly terminated")
...
def test_shell_command_with_stderr():
    ...
    assert mock_stats.tool_errors == 0  # This is not an execution error, just a command with non-zero exit
