#!/usr/bin/env python3
"""
Test the edit_file metadata parameter functionality with updated test cases.
"""
...
def test_metadata_false_by_default():
    ...
    try:
        # First read file to satisfy file tracking
...
def test_metadata_true_shows_suggestions():
    """Test that metadata=True shows full search suggestions for longer content."""
    stats = MockStats()
    ...
    try:
        ...
        # Test with metadata=True - try to edit longer content that will trigger both searches
        ...
        assert "Error: [X] Match not found" in result
        # Should show search suggestions (word search, fuzzy search, or both)
...
def test_metadata_true_fuzzy_search():
    """Test that metadata=True shows fuzzy search for substantial content."""
    stats = MockStats()
    ...
    try:
        ...
        # Test with metadata=True - try to edit substantial content with typo
        old_content = "function my_functio() {\n    return 'hello world';\n}"  # typo in function name
        result = execute_edit_file(
            path=temp_path,
            old_string=old_content,
            new_string="function my_function() {\n    return 'hello world';\n}",
...
def test_critical_errors_always_shown():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Both should show same basic file not found error
...
def test_successful_edit_clean():
    ...
    try:
        ...
        # Both should show same success message
...
if __name__ == "__main__":
    ...
    test_metadata_true_fuzzy_search()
