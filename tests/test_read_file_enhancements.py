...
def test_default_behavior():
    ...
    try:
        ...
        assert len([l for l in lines if l.startswith("Line")]) == 5
...
def test_exact_limit():
    ...
    try:
        ...
        assert len([l for l in lines if l.startswith("Line")]) == 2000
...
def test_memory_efficiency():
    ...
    with tempfile.NamedTemporaryFile(mode='w', delete=False, suffix='.txt') as f:
        ...
        for i in range(10000):
            f.write(f"This is line {i+1} with some content to make it reasonably long\n")
        temp_path = f.name
    ...
    try:
        ...
        content_lines = [l for l in lines if l.startswith("This is line")]
